...
| SPEC-016 | Client-Side Upload Guards for Admin Image Inputs | ready | medium | [SPEC-016-client-side-upload-guards.md](SPEC-016-client-side-upload-guards.md) (2 of 6 inputs blocked on SPEC-013/PR #81 landing on `main`) |
